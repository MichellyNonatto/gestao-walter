...
-- -----------------------------------------------------
INSERT INTO entrada
VALUES	(idEntrada, 572, 3000, '2023-05-25', '2023-11-04', 2, 789654321003),
		(idEntrada, 854, 5000, '2023-05-04', '2024-01-02', 4, 789654321005),
        (idEntrada, 321, 500, '2022-05-25', '2023-02-28', 3, 789654321002),
        (idEntrada, 123, 1000, '2023-06-01', '2026-03-02', 1, 789654321001),
        (idEntrada, 153, 1000, '2023-06-01', '2026-04-02', 1, 789654321004);
...
-- -----------------------------------------------------  
INSERT INTO saida
VALUES	(idSaida, 300, '2023-05-15', "Venda", 789654321003, 1, 2),
		(idSaida, 100, '2023-06-02', "Venda", 789654321005, 5, 2),
        (idSaida, 1000, '2023-06-03', "Venda", 789654321001, 5, 2),
        (idSaida, 300, '2023-06-04', "Vencimento do produto", 789654321002, 4, null),
        (idSaida, 1000, '2023-06-07', "Vencimento do produto", 789654321005, 4, null);
